...
{
    /// <summary>
    /// A HeartRateSensorModule module for Microsoft .NET Gadgeteer
    /// </summary>
    public class HeartRateSensorModule : GTM.Module
    {
        ...
        // GTM.IanLee.HeartRateSensorModule. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the HeartRateSensorModule module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public HeartRateSensorModule(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the HeartRateSensorModule is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="HeartRateSensorModule"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="HeartRateSensorModule"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="HeartRateSensorModule"/></param>
        public delegate void ButtonEventHandler(HeartRateSensorModule sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="HeartRateSensorModule"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="HeartRateSensorModule"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="HeartRateSensorModule"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(HeartRateSensorModule sender, ButtonState buttonState)
        {

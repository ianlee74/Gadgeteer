...
{
    /// <summary>
    /// A LPD8806LedStrip module for Microsoft .NET Gadgeteer
    /// </summary>
    public class LPD8806LedStrip : GTM.Module
    {
        ...
        // GTM.IanLee.LPD8806LedStrip. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the LPD8806LedStrip module.        

        // Note: A constructor summary is auto-generated by the doc builder.
        /// <summary></summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        /// <param name="socketNumberTwo">The second socket that this module is plugged in to.</param>
        public LPD8806LedStrip(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the LPD8806LedStrip is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="LPD8806LedStrip"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LPD8806LedStrip"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="LPD8806LedStrip"/></param>
        public delegate void ButtonEventHandler(LPD8806LedStrip sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="LPD8806LedStrip"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="LPD8806LedStrip"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="LPD8806LedStrip"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(LPD8806LedStrip sender, ButtonState buttonState)
        {
